...
pipeline_options = {
    ...
    'template_location': 'gs://apache-beam-20210820/template/batch_job_df_gcs_big_query',
...
tabela = 'curious-pointer-300801:curso_dataflow_voos.curso_dataflow_voos_atraso'
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location='gs://apache-beam-20210820/temp' )
